...
def get_dataset(train_dir,test_dir, args):
    train_dataset = RecordFileDetection(os.path.join(train_dir,'birds_ssd_sample_train.rec'), coord_normalized=True)
    val_dataset = RecordFileDetection(os.path.join(test_dir,'birds_ssd_sample_val.rec'), coord_normalized=True)
...
if __name__ == '__main__':
    ...
    import os.path
    print(args.train) 
    print(os.path.isfile(os.path.join(args.train, 'birds_ssd_sample_train.rec')))
    ...
    # training data
    train_dataset, val_dataset, eval_metric = get_dataset(args.train, args.test, args)
