...
#call('pip install mxnet-mkl/mxnet-cu90mkl --pre',shell=True)
...
def parse_args():
    ...
    parser.add_argument('--gpus', type=str, default=os.environ['SM_NUM_GPUS'],
...
def get_voc_dataset(dataset, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i, batch in enumerate(train_data):
            ...
            if args.log_interval and not (i + 1) % args.log_interval:
                ...
                print('[Epoch {}][Batch {}], LR: {:.2E}, Speed: {:.3f} samples/sec, {}={:.3f}, {}={:.3f}, {}={:.3f}, {}={:.3f}'.format(epoch, i, trainer.learning_rate, batch_size/(time.time()-btic), name1, loss1, name2, loss2, name3, loss3, name4, loss4))
            btic = time.time()
...
if __name__ == '__main__':
    ...
    # training
    train(net, train_loader, val_loader, eval_metric, ctx, args)